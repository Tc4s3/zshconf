# Generated by Powerlevel10k configuration wizard on 2024-03-12 at 18:41 GMT.
# Based on romkatv/powerlevel10k/config/p10k-lean-8colors.zsh.
# Wizard options: compatible, unicode, lean_8colors, 1 line, sparse, concise,
...
() {
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VIINS_CONTENT_EXPANSION='󰥮'
  # Prompt symbol in command vi mode.
  typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VICMD_CONTENT_EXPANSION='󰥽'
  ...
  typeset -g POWERLEVEL9K_DIR_FOREGROUND=119
  ...
  typeset -g POWERLEVEL9K_DIR_SHORTENED_FOREGROUND=121
  ...
  typeset -g POWERLEVEL9K_CONTEXT_ROOT_FOREGROUND=213
  # Context color in SSH without privileges.
  typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_FOREGROUND=213
  # Default context color (no privileges, no SSH).
  typeset -g POWERLEVEL9K_CONTEXT_FOREGROUND=213
